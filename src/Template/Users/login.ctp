 ...
 <html lang="en">
  ...
  <body class="head_bg">
		...
		<div>
			...
			<?= $this->Form->create('Users', ['class'=>'form-horizontal']) ?>
			  <div class="form-group">
				<div class="col-sm-11">
				  <input type="text" name="email" class="form-control" id="inputtext1" placeholder="Username">
				</div>
			  </div>
			  <div class="form-group">
				<div class="col-sm-11">
				  <input type="password" name="password" class="form-control" id="inputtext6" placeholder="Password">
				</div>
			  </div>
			  
			  <div class="form-group">
				<div class="col-sm-11 text-center">
				  <input type="submit" class="btn btn-default" title="Send now" value="Login" />
				</div>
			  </div>
			  <div class="form-group">
				<div class="col-sm-11 text-center">
				  <p class="login"><i>Don't Have An Account? <?= $this->Html->link('Register Here', ['action' => 'register'], ['escape'=>false]) ?></i></p>
				</div>
			  </div>
			<?= $this->Form->end() ?>
		</div>
	...
	<div class="container foot">
	   <p>COPYRIGHT &copy; 2016 GOHIJAU SDN BHD (888999-M). ALL RIGHTS RESERVED <span class="ML15">|</span> 
